...
encode_msg(Msg, Opts) when
    tuple_size(Msg) >= 1, is_list(Opts)
->
...
e_field_Summary_quantile(
    [Elem | Rest],
    Bin,
    TrUserData
) ->
    Bin2 = <<Bin/binary, 26>>,
    Bin3 = e_mfield_Summary_quantile(
        id(Elem, TrUserData),
        Bin2,
        TrUserData
    ),
    e_field_Summary_quantile(Rest, Bin3, TrUserData);
e_field_Summary_quantile([], Bin, _TrUserData) ->
    Bin.
...
e_field_Histogram_bucket(
    [Elem | Rest],
    Bin,
    TrUserData
) ->
    Bin2 = <<Bin/binary, 26>>,
    Bin3 = e_mfield_Histogram_bucket(
        id(Elem, TrUserData),
        Bin2,
        TrUserData
    ),
    e_field_Histogram_bucket(Rest, Bin3, TrUserData);
e_field_Histogram_bucket([], Bin, _TrUserData) ->
    Bin.
...
e_field_Metric_label([Elem | Rest], Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 10>>,
    Bin3 = e_mfield_Metric_label(
        id(Elem, TrUserData),
        Bin2,
        TrUserData
    ),
    e_field_Metric_label(Rest, Bin3, TrUserData);
e_field_Metric_label([], Bin, _TrUserData) ->
    Bin.
...
e_field_MetricFamily_metric(
    [Elem | Rest],
    Bin,
    TrUserData
) ->
    Bin2 = <<Bin/binary, 34>>,
    Bin3 = e_mfield_MetricFamily_metric(
        id(
            Elem,
            TrUserData
        ),
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_LabelPair(
                        Rest,
                        0,
                        0,
                        F@_1,
...
dg_read_field_def_Gauge(
    ...
    case Key of
        9 ->
            d_field_Gauge_value(Rest, 0, 0, F@_1, TrUserData);
        _ ->
            case Key band 7 of
                0 ->
                    skip_varint_Gauge(Rest, 0, 0, F@_1, TrUserData);
                1 ->
                    skip_64_Gauge(Rest, 0, 0, F@_1, TrUserData);
                2 ->
                    skip_length_delimited_Gauge(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                5 ->
                    skip_32_Gauge(Rest, 0, 0, F@_1, TrUserData)
            end
    end;
...
dg_read_field_def_Counter(
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    skip_varint_Counter(Rest, 0, 0, F@_1, TrUserData);
                1 ->
                    skip_64_Counter(Rest, 0, 0, F@_1, TrUserData);
                2 ->
                    skip_length_delimited_Counter(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                5 ->
                    skip_32_Counter(Rest, 0, 0, F@_1, TrUserData)
            end
    end;
dg_read_field_def_Counter(<<>>, 0, 0, F@_1, _) ->
    #'Counter'{value = F@_1}.

d_field_Counter_value(
    <<0:48, 240, 127, Rest/binary>>,
    Z1,
    Z2,
    _,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_Quantile(
                        Rest,
                        0,
                        0,
                        F@_1,
...
d_field_Summary_quantile(
    ...
    {NewFValue, RestF} = begin
        ...
        {id(decode_msg_Quantile(Bs, TrUserData), TrUserData), Rest2}
    end,
    dfp_read_field_def_Summary(
        RestF,
        0,
...
dg_read_field_def_Untyped(
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    skip_varint_Untyped(Rest, 0, 0, F@_1, TrUserData);
                1 ->
                    skip_64_Untyped(Rest, 0, 0, F@_1, TrUserData);
                2 ->
                    skip_length_delimited_Untyped(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                5 ->
                    skip_32_Untyped(Rest, 0, 0, F@_1, TrUserData)
            end
    end;
dg_read_field_def_Untyped(<<>>, 0, 0, F@_1, _) ->
    #'Untyped'{value = F@_1}.

d_field_Untyped_value(
    <<0:48, 240, 127, Rest/binary>>,
    Z1,
    Z2,
    _,
...
dfp_read_field_def_Histogram(
    ...
    d_field_Histogram_sample_count(
        Rest,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_Histogram(
                        Rest,
                        0,
                        0,
                        F@_1,
...
d_field_Histogram_bucket(
    ...
    {NewFValue, RestF} = begin
        Len = X bsl N + Acc,
        <<Bs:Len/binary, Rest2/binary>> = Rest,
        {id(decode_msg_Bucket(Bs, TrUserData), TrUserData), Rest2}
    end,
    dfp_read_field_def_Histogram(
        RestF,
        0,
...
dfp_read_field_def_Bucket(
    ...
    d_field_Bucket_cumulative_count(
        Rest,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                1 ->
                    skip_64_Bucket(Rest, 0, 0, F@_1, F@_2, TrUserData);
                2 ->
                    skip_length_delimited_Bucket(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                5 ->
                    skip_32_Bucket(Rest, 0, 0, F@_1, F@_2, TrUserData)
            end
    end;
...
dfp_read_field_def_Metric(
    ...
    #'Metric'{
        label = lists_reverse(R1, TrUserData),
        gauge = F@_2,
        counter = F@_3,
        summary = F@_4,
        untyped = F@_5,
...
d_field_Metric_label(
    ...
    {NewFValue, RestF} = begin
        ...
        {
            id(
                decode_msg_LabelPair(Bs, TrUserData),
                TrUserData
            ),
            Rest2
        }
...
d_field_Metric_gauge(
    ...
    {NewFValue, RestF} = begin
        Len = X bsl N + Acc,
        <<Bs:Len/binary, Rest2/binary>> = Rest,
        {id(decode_msg_Gauge(Bs, TrUserData), TrUserData), Rest2}
    end,
    dfp_read_field_def_Metric(
        RestF,
        0,
...
d_field_Metric_counter(
    ...
    {NewFValue, RestF} = begin
        Len = X bsl N + Acc,
        <<Bs:Len/binary, Rest2/binary>> = Rest,
        {id(decode_msg_Counter(Bs, TrUserData), TrUserData), Rest2}
    end,
    dfp_read_field_def_Metric(
        RestF,
        0,
...
d_field_Metric_summary(
    ...
    {NewFValue, RestF} = begin
        Len = X bsl N + Acc,
        <<Bs:Len/binary, Rest2/binary>> = Rest,
        {id(decode_msg_Summary(Bs, TrUserData), TrUserData), Rest2}
    end,
    dfp_read_field_def_Metric(
        RestF,
        0,
...
d_field_Metric_untyped(
    ...
    {NewFValue, RestF} = begin
        Len = X bsl N + Acc,
        <<Bs:Len/binary, Rest2/binary>> = Rest,
        {id(decode_msg_Untyped(Bs, TrUserData), TrUserData), Rest2}
    end,
    dfp_read_field_def_Metric(
        RestF,
        0,
...
d_field_Metric_histogram(
    ...
    {NewFValue, RestF} = begin
        ...
        {
            id(
                decode_msg_Histogram(Bs, TrUserData),
                TrUserData
            ),
            Rest2
        }
...
decode_msg_MetricFamily(Bin, TrUserData) ->
    dfp_read_field_def_MetricFamily(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
dfp_read_field_def_MetricFamily(
    ...
    dg_read_field_def_MetricFamily(
        Other,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_MetricFamily(
                        Rest,
                        0,
                        0,
                        F@_1,
...
d_field_MetricFamily_metric(
    ...
    {NewFValue, RestF} = begin
        Len = X bsl N + Acc,
        <<Bs:Len/binary, Rest2/binary>> = Rest,
        {id(decode_msg_Metric(Bs, TrUserData), TrUserData), Rest2}
    end,
    dfp_read_field_def_MetricFamily(
        RestF,
        0,
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
        ...
        'Gauge' ->
            merge_msg_Gauge(Prev, New, TrUserData);
        'Counter' ->
        ...
        'Bucket' ->
            merge_msg_Bucket(Prev, New, TrUserData);
        'Metric' ->
            merge_msg_Metric(Prev, New, TrUserData);
        'MetricFamily' ->
...
merge_msg_Summary(
    #'Summary'{
        sample_count =
            PFsample_count,
        sample_sum = PFsample_sum,
        quantile = PFquantile
    },
    #'Summary'{
        sample_count = NFsample_count,
    ...
    #'Summary'{
        sample_count =
            if
                NFsample_count =:= undefined -> PFsample_count;
                true -> NFsample_count
            end,
        sample_sum =
            if
                NFsample_sum =:= undefined -> PFsample_sum;
                true -> NFsample_sum
            end,
        quantile =
            if
                PFquantile /= undefined, NFquantile /= undefined ->
                    'erlang_++'(PFquantile, NFquantile, TrUserData);
                PFquantile == undefined ->
                    NFquantile;
                NFquantile == undefined ->
                    PFquantile
            end
    }.
...
merge_msg_Histogram(
    ...
    #'Histogram'{
        ...
        bucket =
            if
                PFbucket /= undefined, NFbucket /= undefined ->
...
merge_msg_Bucket(
    ...
    #'Bucket'{
        cumulative_count = NFcumulative_count,
    ...
    #'Bucket'{
        ...
        upper_bound =
            if
                NFupper_bound =:= undefined -> PFupper_bound;
                true -> NFupper_bound
            end
    }.
...
merge_msg_Metric(
    ...
    #'Metric'{
        label =
            if
                PFlabel /= undefined, NFlabel /= undefined ->
        ...
        gauge =
            if
                PFgauge /= undefined, NFgauge /= undefined ->
        ...
        counter =
            if
                PFcounter /= undefined, NFcounter /= undefined ->
        ...
        summary =
            if
                PFsummary /= undefined, NFsummary /= undefined ->
        ...
        untyped =
            if
                PFuntyped /= undefined, NFuntyped /= undefined ->
        ...
        histogram =
            if
                PFhistogram /= undefined, NFhistogram /= undefined ->
                    merge_msg_Histogram(
                        PFhistogram,
                        NFhistogram,
                        TrUserData
                    );
                PFhistogram == undefined ->
                    NFhistogram;
                NFhistogram == undefined ->
                    PFhistogram
            end,
        timestamp_ms =
            if
                NFtimestamp_ms =:= undefined -> PFtimestamp_ms;
                true -> NFtimestamp_ms
            end
    }.

-compile({nowarn_unused_function, merge_msg_MetricFamily/3}).
merge_msg_MetricFamily(
    #'MetricFamily'{
        name = PFname,
        help = PFhelp,
        type = PFtype,
    ...
    #'MetricFamily'{
        ...
        metric =
            if
                PFmetric /= undefined, NFmetric /= undefined ->
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        ...
        'Gauge' ->
            v_msg_Gauge(Msg, [MsgName], TrUserData);
        'Counter' ->
            v_msg_Counter(Msg, [MsgName], TrUserData);
        'Quantile' ->
            v_msg_Quantile(Msg, [MsgName], TrUserData);
        'Summary' ->
            v_msg_Summary(Msg, [MsgName], TrUserData);
        'Untyped' ->
            v_msg_Untyped(Msg, [MsgName], TrUserData);
        'Histogram' ->
            v_msg_Histogram(Msg, [MsgName], TrUserData);
        'Bucket' ->
            v_msg_Bucket(Msg, [MsgName], TrUserData);
        'Metric' ->
            v_msg_Metric(Msg, [MsgName], TrUserData);
        'MetricFamily' ->
...
v_msg_Summary(
    ...
    if
        is_list(F3) ->
            _ = [
                v_msg_Quantile(Elem, [quantile | Path], TrUserData)
             || Elem <- F3
            ],
            ok;
        true ->
            mk_type_error(
                {invalid_list_of, {msg, 'Quantile'}},
                F3,
                [quantile | Path]
            )
    end,
...
v_msg_Histogram(
    ...
    if
        is_list(F3) ->
            _ = [
                v_msg_Bucket(Elem, [bucket | Path], TrUserData)
             || Elem <- F3
            ],
            ok;
        true ->
            mk_type_error(
                {invalid_list_of, {msg, 'Bucket'}},
                F3,
                [bucket | Path]
            )
    end,
...
v_msg_Metric(
    ...
    if
        is_list(F1) ->
            _ = [
                v_msg_LabelPair(Elem, [label | Path], TrUserData)
             || Elem <- F1
            ],
            ok;
        true ->
            mk_type_error(
                {invalid_list_of, {msg, 'LabelPair'}},
                F1,
                [label | Path]
            )
    end,
    ...
    if
        F6 == undefined -> ok;
        true -> v_msg_Histogram(F6, [histogram | Path], TrUserData)
    end,
    if
        F7 == undefined -> ok;
...
v_msg_MetricFamily(
    ...
    if
        is_list(F4) ->
            _ = [
                v_msg_Metric(Elem, [metric | Path], TrUserData)
             || Elem <- F4
            ],
            ok;
        true ->
            mk_type_error(
                {invalid_list_of, {msg, 'Metric'}},
                F4,
                [metric | Path]
            )
    end,
...
v_enum_MetricType('COUNTER', _Path, _TrUserData) ->
    ok;
v_enum_MetricType('GAUGE', _Path, _TrUserData) ->
    ok;
v_enum_MetricType('SUMMARY', _Path, _TrUserData) ->
    ok;
v_enum_MetricType('UNTYPED', _Path, _TrUserData) ->
    ok;
v_enum_MetricType('HISTOGRAM', _Path, _TrUserData) ->
    ok;
v_enum_MetricType(V, Path, TrUserData) when
    is_integer(V)
->
...
->
    ok;
v_type_uint64(N, Path, _TrUserData) when
    is_integer(N)
->
    mk_type_error(
...
v_type_double(N, _Path, _TrUserData) when is_float(N) ->
    ok;
v_type_double(N, _Path, _TrUserData) when
    is_integer(N)
->
    ok;
